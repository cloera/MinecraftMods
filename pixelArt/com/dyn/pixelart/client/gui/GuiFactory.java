...
import com.dyn.pixelart.common.ConfigHandler;
...
public class GuiFactory implements IModGuiFactory {
	...
	public static class GuiModConfig extends GuiConfig {
		...
		/*
		 * public GuiModConfig(GuiScreen guiScreen) { super(new
		 * ConfigElement(ConfigHandler.configuration.getCategory("general")).
		 * getChildElements(), "PrinterBlock", false, false,
